...
class DSB-SC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DSB-SC")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 11000, 100, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=DSB-SC, options=None):
