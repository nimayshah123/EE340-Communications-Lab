...
class SSB(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SSB")
        ...
        self.tab.addTab(self.tab_widget_4, 'demod_f')
        ...
        self.tab.addTab(self.tab_widget_5, 'm2_demod_f')
        ...
        self.tab_layout_3.addWidget(self._qtgui_time_sink_x_0_0_0_win)
        ...
        self.tab_layout_5.addWidget(self._qtgui_freq_sink_x_1_win)
        ...
        self.blocks_wavfile_source_2 = blocks.wavfile_source('/home/nimayshah/Downloads/vocal(1).wav', True)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 200000, (-1), 0, 0)
        ...
        self.connect((self.blocks_complex_to_imag_0, 0), (self.blocks_multiply_xx_0_0, 1))
        ...
        self.connect((self.blocks_wavfile_source_2, 0), (self.rational_resampler_xxx_2, 0))
        self.connect((self.hilbert_fc_0, 0), (self.blocks_complex_to_imag_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.audio_sink_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_2, 0), (self.hilbert_fc_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(2, self.samp_rate, 20000, 100, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(2, self.samp_rate, 20000, 100, window.WIN_HAMMING, 6.76))
