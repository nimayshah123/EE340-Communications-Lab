...
class DSBSC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DSBSC")
        ...
        self.tab.addTab(self.tab_widget_0, 'Mod')
        self.tab_widget_1 = Qt.QWidget()
        self.tab_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_1)
        self.tab_grid_layout_1 = Qt.QGridLayout()
        self.tab_layout_1.addLayout(self.tab_grid_layout_1)
        self.tab.addTab(self.tab_widget_1, 'Mod_f')
        ...
        self.tab.addTab(self.tab_widget_3, 'Demod_f')
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(2, self.samp_rate, 20000, 100, window.WIN_RECTANGULAR, 6.76))
...
def main(top_block_cls=DSBSC, options=None):
