...
class namesy(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "DSBFC", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("DSBFC")
        ...
        self.settings = Qt.QSettings("GNU Radio", "namesy")
        ...
        self.tab.addTab(self.tab_widget_4, 'Demodulated_Freq')
        ...
        self.tab.addTab(self.tab_widget_5, 'LPF output')
        ...
        self.tab.addTab(self.tab_widget_6, 'LPF -1')
        ...
        self.tab_layout_6.addWidget(self._qtgui_time_sink_x_1_1_win)
        ...
        self.tab_layout_5.addWidget(self._qtgui_time_sink_x_1_0_win)
        ...
        self.tab_layout_4.addWidget(self._qtgui_freq_sink_x_1_win)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/nimayshah/Downloads/vocal(1).wav', True)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff((1/x))
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(x)
        ...
        self.connect((self.blocks_add_const_vxx_1, 0), (self.qtgui_time_sink_x_1_1, 0))
    ...
    def set_x(self, x):
        ...
        self.blocks_multiply_const_vxx_1.set_k((1/self.x))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(2, self.samp_rate, 20000, 10, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=namesy, options=None):
