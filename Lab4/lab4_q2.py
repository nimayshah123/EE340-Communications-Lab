...
class lab4_q2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab4_q2")
        ...
        self._amplitude_range = qtgui.Range(0.01, 1, 0.01, 0.01, 200)
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff(0.00151)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 600000, amplitude, 0, 0)
        ...
        self.connect((self.blocks_transcendental_0, 0), (self.blocks_multiply_const_vxx_3, 0))
...
def main(top_block_cls=lab4_q2, options=None):
