...
class lab4_q1_b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab4_q1_b")
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff(((amplitude/0.025)))
    ...
    def set_amplitude(self, amplitude):
        ...
        self.blocks_multiply_const_vxx_1.set_k(((self.amplitude/0.025)))




def main(top_block_cls=lab4_q1_b, options=None):
